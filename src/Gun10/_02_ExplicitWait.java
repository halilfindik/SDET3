...
public class _02_ExplicitWait extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(30)); // explicit wait için bunu tanımlamam lazım
        ...
        // Burada verilen wait süresi, implicitly wait süresinin üzerine eklenmektedir

        // Bunu WebElement webrDriverText=wait.until..... şeklide de yazabiliyorsun, böylece elemanı bir daha
        // aşağıdaki gibi tanımlamaya gerek kalmıyor; hem bekleme veriyorsun hem elemanı tanımlamış oluyorsun.

        WebElement webDriverText=driver.findElement(By.xpath("//p[text()='WebDriver']"));
        // bu eleman görünür olana dek bekle diyebilmem lazım
    ...
    Implicit Wait  : Bütün elemanlar için geçerli, bir kere tanımlanır.
    Explicit Wait  : Tek bir elemana özel kriter olarak tanımlanır, sadece ilgili elemanda geçerli olur.
